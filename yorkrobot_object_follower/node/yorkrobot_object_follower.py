...
class ClbrobotObjectFollower():
    def __init__(self):
        rospy.init_node('yorkrobot_people_follower_node', log_level=rospy.INFO)
	...
	#im_sub = message_filters.Subscriber(self.camera_topic, Image)
        ...
        self.object_sub = rospy.Subscriber("/yorkrobot_detect_node/detections", Detection2DArray, self.ObjectCallback)
