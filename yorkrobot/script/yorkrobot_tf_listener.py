...
if __name__ == '__main__':
    ...
    yorkrobot_vel = rospy.Publisher(follow_robot + '/cmd_vel', geometry_msgs.msg.Twist, queue_size=1)
    ...
    while not rospy.is_shutdown():
        ...
        yorkrobot_vel.publish(msg) #向/robot2/cmd_vel话题发布新坐标  (即robot2根据/robot2/cmd_vel的数据来控制robot2移动)
        rate.sleep()
