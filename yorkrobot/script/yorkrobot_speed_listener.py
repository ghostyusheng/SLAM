...
class MultiRobotVelFollower():
    def __init__(self):
        ...
        self.yorkrobot_vel_pub = rospy.Publisher(follow_robot + '/cmd_vel', Twist, queue_size=1)
        self.yorkrobot_vel_sub = rospy.Subscriber(listen_robot + '/cmd_vel', Twist, self.cbGetVel, queue_size=1)
        #self.linear_x = 0.0
        #self.angular_z = 0.0
    ...
    def cbGetVel(self, vel_msg):
        ...
        self.yorkrobot_vel_pub.publish(vel)




if __name__ == '__main__':
    rospy.init_node('yorkrobot_multi')
